...
用途: 从Stage2 (mediators.csv) 生成6个任务组的训练数据文件
作者: Claude
日期: 2025-12-24
"""
...
# 任务组配置（6组方案 - 2025-12-24最终版）
# 说明: 在5组基础上新增MRT-OAST任务组，覆盖所有11个模型
TASK_GROUPS = {
...
示例用法:
  ...
  # 指定输出目录
  python3 generate_6groups_data.py --output-dir /path/to/output
        """
    )
    ...
    parser.add_argument(
        '--input',
        type=str,
        default='../data/energy_research/processed.backup_4groups_20251224/stage2_mediators.csv',
        help='输入CSV文件路径（默认: stage2_mediators.csv from backup）'
    )
