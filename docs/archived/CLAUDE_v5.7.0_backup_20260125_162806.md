...
| 文档 | 用途 |
|------|------|
| [docs/reference/QUICK_REFERENCE.md](docs/reference/QUICK_REFERENCE.md) | 快速参考手册 |
| [docs/reference/SCRIPTS_QUICKREF.md](docs/reference/SCRIPTS_QUICKREF.md) | 脚本快速参考 |
| [docs/reference/FEATURES_OVERVIEW.md](docs/reference/FEATURES_OVERVIEW.md) | 功能特性总览 |
...
| [docs/guides/JSON_CONFIG_BEST_PRACTICES.md](docs/guides/JSON_CONFIG_BEST_PRACTICES.md) | 配置最佳实践 |
| [docs/specs/11_MODELS_FINAL_DEFINITION.md](docs/specs/11_MODELS_FINAL_DEFINITION.md) | 11个模型定义 |
...
**完整列表**: 参见 [docs/reference/SCRIPTS_QUICKREF.md](docs/reference/SCRIPTS_QUICKREF.md)
...
```bash
# 步骤1: 查阅脚本文档
cat docs/reference/SCRIPTS_QUICKREF.md
