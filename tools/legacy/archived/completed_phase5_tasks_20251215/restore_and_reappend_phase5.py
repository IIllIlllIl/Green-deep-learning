...
def restore_and_expand():
    ...
    backup_file = Path('data/raw_data.csv.backup_20251215_171809')
    output_file = Path('data/raw_data.csv')
...
if __name__ == '__main__':
    ...
    if success:
        ...
        print('  python3 tools/data_management/append_session_to_raw_data.py results/run_20251214_160925')
    else:
        print('❌ 恢复失败')
    print('=' * 80)
