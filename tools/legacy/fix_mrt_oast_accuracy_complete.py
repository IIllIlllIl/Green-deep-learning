...
def fix_old_mrt_oast_data():
    ...
    backup_file = 'data/raw_data.csv.backup_before_full_fix'
...
if __name__ == '__main__':
    ...
    print()
    print("下一步:")
    print("  mv results/raw_data_fully_fixed.csv data/raw_data.csv")
    print("  python3 tools/data_management/create_unified_data_csv.py")
