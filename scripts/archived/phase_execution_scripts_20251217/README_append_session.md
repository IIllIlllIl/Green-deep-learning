...
# 步骤2: Dry-run检查
python3 scripts/append_session_to_raw_data.py $(ls -td results/run_* | head -1) --dry-run

# 步骤3: 实际执行
python3 scripts/append_session_to_raw_data.py $(ls -td results/run_* | head -1)
```
