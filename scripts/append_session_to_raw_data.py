...
用法：
    ...
    python3 scripts/append_session_to_raw_data.py results/run_YYYYMMDD_HHMMSS --no-backup
...
# 默认配置
DEFAULT_RAW_DATA_CSV = Path('results/raw_data.csv')
...
class SessionDataAppender:
    ...
    def __init__(self, session_dir, raw_data_csv=None, models_config_path=None,
        ...
        Args:
            ...
            raw_data_csv: raw_data.csv路径（默认：results/raw_data.csv）
